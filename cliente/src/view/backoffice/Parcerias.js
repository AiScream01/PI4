...
<div className='justify-content-top align-items-center border rounded-2 d-flex flex-column ' style={{width: "100%", backgroundColor: '#FFFFFF', shadow: '10px 10px 15px grey'}}>
<br></br>
            <div className="row">
